...
//徳島県道路通行規制情報 Google Maps API 版 ver0.4 by y.niji 2013/11/15 Google Maps API Ver3に対応
var map;
var geocoder=null;
...
function loadTraffic(markerXml) {
    if (markerXml.getElementsByTagName("cd").length == 0)
        var iconsource = "08_98.png";
    else 
